 ...
 */
@interface CLIWeatherAPIClient: AWSAPIGatewayClient
 ...
 *Swift*
     ...
     let serviceClient = CLIWeatherAPIClient.defaultClient()

 *Objective-C*

     CLIWeatherAPIClient *serviceClient = [CLIWeatherAPIClient defaultClient];
 ...
 *Swift*
     ...
     func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
         ...
         CLIWeatherAPIClient.registerClientWithConfiguration(configuration, forKey: "USWest2CLIWeatherAPIClient")
 ...
 *Swift*
     ...
     let serviceClient = CLIWeatherAPIClient(forKey: "USWest2CLIWeatherAPIClient")

 *Objective-C*

     CLIWeatherAPIClient *serviceClient = [CLIWeatherAPIClient clientForKey:@"USWest2CLIWeatherAPIClient"];
...
/**
 ...
 return type: CLIWeather *
 */
- (AWSTask *)weatherGet:(nullable NSString *)appid q:(nullable NSString *)q;
