...
@implementation CLIWeatherAPIClient
...
+ (instancetype)defaultClient {
    ...
    static CLIWeatherAPIClient *_defaultClient = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        _defaultClient = [[CLIWeatherAPIClient alloc] initWithConfiguration:serviceConfiguration];
    });
...
+ (void)registerClientWithConfiguration:(AWSServiceConfiguration *)configuration forKey:(NSString *)key {
    ...
    [_serviceClients setObject:[[CLIWeatherAPIClient alloc] initWithConfiguration:configuration]
                        forKey:key];
}
...
- (instancetype)initWithConfiguration:(AWSServiceConfiguration *)configuration {
    if (self = [super init]) {
        ...
        NSString *URLString = @"https://bs70x818lf.execute-api.ap-northeast-1.amazonaws.com/prod";
...
- (AWSTask *)weatherGet:(NSString *)appid q:(NSString *)q {
    ...
    return [self invokeHTTPRequest:@"GET"
                  ...
                  headerParameters:headerParameters
                              body:nil
                     responseClass:[CLIWeather class]];
}
